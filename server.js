...
- "혀가 돌게", "군침이 돌게", "자꾸 생각나는 향", "먹는 순간", "입에서 풀리는", "사르르", "녹아내리는", "녹아내릴 것 같았어요", "황금빛", "appetizing" 같은 작가스럽거나 어색한 표현은 쓰지 마.
- 영어 감탄 표현이나 영어 형용사를 섞지 마. appetizing, nice, good 같은 영어 표현 금지.
- 비유, 은유, 의인화 금지. 음식이나 제품이 움직이는 것처럼 쓰지 마.
- "고기가 발걸음하는 느낌", "접시 위에서 춤추는", "눈길을 사로잡는", "이야기를 건네는" 같은 표현 절대 금지.
- 사진에서 보이는 모양을 억지로 해석하지 마. "말린 모습", "가지런히", "고르기 어려워"처럼 근거 없는 판단도 쓰지 마.
- 누가 어려워했는지, 누가 기대했는지, 누가 감탄했는지 사진이나 메모에 없으면 지어내지 마.
- 음식 사진은 보이는 메뉴명과 상태만 담백하게 써. 예: "삼겹살이 접시에 나왔어요", "두께가 꽤 있었어요", "버섯도 같이 나왔어요".
...
- 아래 표현은 사용하지 마:
  풍미, 감동, 입안 가득, 최고의 조화, 특별한 경험, 행복한 시간, 완벽한 식감, 웅장하게 등장, 기대감이 커졌어요, 혀가 돌게, 군침이 돌게, 사르르, 녹아내리는, 녹아내릴 것 같았어요, 황금빛, appetizing, 우연히 방문하게 된, 매력적이었어요, 뿌듯했어요, 다양하게, 각종, 가지런히, 취향에 맞게, 먹음직스럽게 말린, 말린 모습, 고르기 어려워, 발걸음하는 느낌, 눈길을 사로잡는
